...
// 		// NOTE: Доработает свою последнюю рабочую итерацию
// 		select {
// 		case <-ctx.Done():
...
// 			// fmt.Println("Почтальон №", n, "Донёс письмо до почты:", mail)
...
// NOTE: Этот почтальон завершит своё выполнение СРАЗУ после сигнала о завершении рабочего дня
func Postman(ctx context.Context,
	wg *sync.WaitGroup,
